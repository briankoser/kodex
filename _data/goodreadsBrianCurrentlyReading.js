...
module.exports = async function() {
  console.log("Fetching Goodreads Brian currently reading…");

  const URL_GOODREADS_BRIAN_CURRENTLY_READING = `https://www.goodreads.com/review/list_rss/4812558?key=Iu1W8E_OaZK1MDo5zpn3CYRBY78RlHrQIGswdyIFN9g3TIYT&shelf=currently-reading`;
  let rss = await Cache(URL_GOODREADS_BRIAN_CURRENTLY_READING, {
    duration: "1d",
    type: "xml"
  });
