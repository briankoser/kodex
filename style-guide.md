...
<h3>Open Sans - numero sign</h3>
<div class="demo">
    <span class="h1" style="font-family:'OpenSansNumero';">№</span>
</div>

<h3>Open Sans (bold) - numero sign</h3>
<div class="demo">
    <span class="h1" style="font-family:'OpenSansNumero'; font-weight:bold;">№</span>
</div>

<h3>Open Sans (italic) - numero sign</h3>
<div class="demo">
    <span class="h1" style="font-family:'OpenSansNumero'; font-style:italic;">№</span>
</div>

<h3>Open Sans (bold, italic) - numero sign</h3>
<div class="demo">
    <span class="h1" style="font-family:'OpenSansNumero'; font-weight:bold; font-style:italic;">№</span>
</div>

<h3>Open Sans Light - numero sign for headers</h3>
<div class="demo">
    <span class="h1" style="font-family:'OpenSansLightNumero';">№</span>
</div>

<h3>Open Sans Light (italic) - numero sign for headers</h3>
<div class="demo">
    <span class="h1" style="font-family:'OpenSansLightNumero'; font-style:italic;">№</span>
</div>
